  ...
  try {
    ...
    const requestPath =
      process.env.NODE_ENV === 'development'
        ...
        : 'https://sentiment-analysis-seven.vercel.app/api/python'; //`${request.headers.get('host')}/api/python`; 'https://sentiment-analysis-seven.vercel.app/api/python'; /api/python
